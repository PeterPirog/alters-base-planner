...
class PlanResult:
    ...
    fixed_incumbent_distance_cap_pruning_used: bool = False
    fixed_objective_bound_relaxation_pruned: bool = False
    max_fixed_relaxed_graph_primary_lower_bound: int | None = None
    min_fixed_incumbent_primary_bound: int | None = None
    max_fixed_incumbent_distance_cap_pairs: int = 0
    max_fixed_source_flow_variables_before_incumbent_cap: int = 0
    max_fixed_source_flow_variables_after_incumbent_cap: int = 0
    max_fixed_incumbent_cap_pruned_flow_variables: int = 0
